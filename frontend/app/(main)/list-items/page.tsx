...
function DeliveryOptionCard({
  ...
  return (
    ...
    >
      <span className={active ? 'text-[#A33214]' : 'text-[#8A7060]'}>
        {icon}
      </span>
      {title}
    </button>
...
function FeeTypeCard({
  ...
  return (
    ...
    >
      <p
        className={`text-[13px] font-semibold ${active ? 'text-[#A33214]' : 'text-[#2A1F1A]'}`}
      >
        {title}
      </p>
...
// type them (and can't accidentally submit with district blank).
  ...
  const handleUseMyLocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      () => {
        toast.error(
          "Couldn't fetch your location. Please allow location access.",
        );
      },
    );
  };
  ...
  const validate = (): string | null => {
    ...
    if (
      ...
      if (!form.shippingAvailability)
        return 'Shipping availability is required.';
    ...
    if (
      ...
      if (!form.pickupLocationConfirmed)
        return 'Please pin your exact pickup location.';
      if (!form.pickupContactNumber.trim())
        return 'Pickup contact number is required.';
      if (form.pickupDays.length === 0)
        return 'Select at least one pickup availability day.';
      if (!form.pickupTimeFrom || !form.pickupTimeTo)
        return 'Pickup time range is required.';
    }
  ...
  const buildFormData = () => {
    ...
    if (form.defectFlaws.trim())
      fd.append('defectFlaws', form.defectFlaws.trim());
        ...
        <div className="px-4 sm:px-8 md:px-12 lg:px-16 py-6 sm:py-8 lg:py-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4 sm:gap-6">
          ...
          <button className="inline-flex items-center gap-3 rounded-2xl border border-[#E0D4C8] bg-white px-4 sm:px-5 py-3 sm:py-3.5 text-[13px] sm:text-[14px] font-medium text-[#3D322B] transition-colors hover:bg-[#FDF6EC] hover:border-[#CBBDAF] shrink-0 shadow-sm self-start md:self-auto">
            <HelpCircle
              size={18}
              strokeWidth={1.8}
              className="text-[#6F5E52] flex-shrink-0"
            />
            <span>
              Need help? Check our{' '}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {(['Thrift', 'Rent', 'Thrift + Rent'] as ListingMode[]).map(
                      (mode) => (
                        <button
                          key={mode}
          ...
          <div className="bg-white rounded-xl border border-[#E8DDD0] overflow-hidden">
            <div className="flex items-center gap-3 px-4 sm:px-7 py-4 sm:py-5 border-b border-[#F0E6DA]">
              ...
              <div>
                ...
                <p className="text-[12px] sm:text-[13px] text-[#8A7060] mt-0.5">
                  Add up to 4 photos and 1 video. Clear photos build trust and
                  sell faster.
                </p>
              </div>
            </div>
            ...
            <div className="px-4 sm:px-7 py-5 sm:py-6 flex flex-col gap-6">
              ...
              <div>
                <p className="text-[13px] font-semibold text-[#3D2B1F] mb-3">
                  Photos{' '}
                  <span className="font-normal text-[#8A7060]">(Max 4)</span>
                </p>
              ...
              <div>
                <p className="text-[13px] font-semibold text-[#3D2B1F] mb-3">
                  Video{' '}
                  <span className="font-normal text-[#8A7060]">(Optional)</span>
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <div className="bg-[#FDFAF6] border border-[#E8DDD0] rounded-2xl px-5 py-4 w-full sm:w-[210px] flex-shrink-0">
                    <div className="flex items-center gap-1.5 mb-2.5">
                      ...
                      <p className="text-[12px] font-semibold text-[#2A1F1A]">
                    ...
                    {[
                      ...
                      >
                        <CheckCircle
                          size={12}
                          className="text-[#3D5C30] flex-shrink-0"
                        />
                        <span className="text-[12px] text-[#6F6258]">
                          {tip}
                        </span>
                      </div>
                    ))}
          ...
          <div className="bg-white rounded-xl border border-[#E8DDD0] overflow-hidden">
            <div className="flex items-center gap-3 px-4 sm:px-7 py-4 sm:py-5 border-b border-[#F0E6DA]">
              ...
              <div>
                ...
                <p className="text-[12px] sm:text-[13px] text-[#8A7060] mt-0.5">
                  Write an honest, clear description to help buyers understand
                  the item better.
                </p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl border border-[#E8DDD0] overflow-hidden">
            <div className="flex items-center gap-3 px-4 sm:px-7 py-4 sm:py-5 border-b border-[#F0E6DA]">
              ...
              <div>
                ...
                <p className="text-[12px] sm:text-[13px] text-[#8A7060] mt-0.5">
                  Provide accurate details to improve discoverability and buyer
                  confidence.
                </p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl border border-[#E8DDD0] overflow-hidden">
            <div className="flex items-center gap-3 px-4 sm:px-7 py-4 sm:py-5 border-b border-[#F0E6DA]">
              ...
              <div>
                ...
                <p className="text-[12px] sm:text-[13px] text-[#8A7060] mt-0.5">
                  Choose how buyers can receive this item. You can offer one or
                  both options.
                </p>
              </div>
            </div>
            ...
            <div className="px-4 sm:px-7 py-5 sm:py-6 flex flex-col gap-6">
              ...
              {form.deliveryOption === 'Flex (Both)' && (
                <div className="flex items-center gap-2 bg-[#F2FAF0] border border-[#D8E8D0] rounded-xl px-4 py-2.5 text-[12px] text-[#3D5C30]">
                  ...
                  Great choice! Buyers can choose the option that works best for
                  them.
                </div>
              )}
              ...
              {(form.deliveryOption === 'Shipping' ||
                ...
                <div className="border-t border-[#F0E6DA] pt-5 flex flex-col gap-5">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <FeeTypeCard
                        ...
                        onClick={() =>
                          update('shippingFeeType', 'Free Shipping')
                        }
                      />
                      <FeeTypeCard
                        title="Fixed Fee"
                      ...
                      <FeeTypeCard
                        ...
                        onClick={() =>
                          update('shippingFeeType', 'Dynamic Shipping')
                        }
                      />
                    </div>
                  </div>
                  ...
                  {/*      <Info*/}
                  {/*        size={12}*/}
                  {/*        className="text-[#8A7060] flex-shrink-0"*/}
                  {/*      />*/}
                  {/*      <p className="text-[11px] text-[#6F6258]">*/}
                  {/*        Dynamic shipping fee is calculated from the distance*/}
                  {/*        between your delivery location and the buyer's.*/}
                  {/*      </p>*/}
                  {/*    </div>*/}
                  ...
                  {/*      These rates will be shown to buyers based on their*/}
                  {/*      delivery location.*/}
                  {/*    </p>*/}
                  {/*  </div>*/}
                  {/*)}*/}
            ...
            {form.sellerLocationConfirmed ? 'Update Pin' : 'Select My Location'}
                  ...
                  />
                  <p className="text-[11px] text-[#8A7060] -mt-3">
                    This is the time you need to prepare the item before it's
              ...
              {(form.deliveryOption === 'Pickup' ||
                ...
                <div className="border-t border-[#F0E6DA] pt-5 flex flex-col gap-5">
                  ...
                  />
                  <p className="text-[11px] text-[#8A7060] -mt-3">
                    This area will be visible to buyers before they place an
                    order.
                  </p>
                  ...
                  <div>
                    ...
                    <p className="text-[12px] text-[#8A7060] mb-2.5">
                      Pin your exact pickup location on the map — click or drag
                    ...
                    {form.pickupLocationConfirmed ? (
                      ...
                      <p className="text-[11px] text-[#8A7060] mt-2">
                        No pin set yet — click on the map or use &quot;Select My
                        Location&quot;.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-stretch">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            update('pickupContactNumber', e.target.value)
                          }
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          update('pickupInstructions', e.target.value)
                        }
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          update('pickupTimeFrom', e.target.value)
                        }
                  ...
                  <label className="flex items-center gap-2 text-[13px] font-medium text-[#3D2B1F] cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        update('sameDayPickup', e.target.checked)
                      }
            ...
            <div className="px-4 sm:px-7 py-5 sm:py-6">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[14px] text-[#8A7060] font-medium">
                      Rs
                    </span>
                    <input
                      type="text"
          ...
          <div className="lg:sticky lg:top-6">
            <div className="bg-white rounded-xl border border-[#E8DDD0] overflow-hidden">
              ...
              <div className="px-5 pt-5 pb-3 border-b border-[#F0E6DA]">
                <p className="text-[15px] font-serif font-bold text-[#2A1F1A]">
                  Listing Preview
                </p>
              ...
              <div className="relative bg-[#F8F4EF] aspect-[4/5] overflow-hidden">
                {showVideo ? (
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center text-[#C8BAA8]">
                    ...
                    <p className="text-[11px] mt-2">Upload photos to preview</p>
                  </div>
                )}
                  ...
                  return (
                    <button
                      ...
                      className={`w-14 h-14 rounded-xl overflow-hidden border-2 flex-shrink-0 transition-all ${
                        isActive ? 'border-[#A33214]' : 'border-[#E8DDD0]'
                      }`}
                    >
                      <img
                        src={photo}
              ...
              <div className="px-4 py-4 flex flex-col gap-3">
                ...
                {(form.thriftPrice || form.rentPerDay) && (
                  <div className="flex items-baseline gap-2 flex-wrap">
                    ...
                    {form.rentPerDay && form.pricingMode !== 'Thrift' && (
                      <span className="text-[20px] font-bold text-[#A33214]">
                        Rs {form.rentPerDay}
                        <span className="text-[12px] font-normal text-[#8A7060] ml-1">
                          / day
                        </span>
                      </span>
                    )}
                    {form.originalPrice && (
                      <span className="text-[12px] text-[#BBA898] line-through font-normal">
                ...
                {/* Attributes pills */}
                {[form.size, form.condition, form.color, form.material].some(
                  Boolean,
                ) && (
                    ...
                    {form.tags &&
                      form.tags
                        ...
                        .map((tag) => (
                          <span
                            key={tag.trim()}
                            className="text-[10px] bg-[#FDF6EC] border border-[#EBE0D4] text-[#8A7060] px-2 py-0.5 rounded-full"
                          >
                            {tag.trim()}
                          </span>
                        ))}
                ...
                {form.description && (
                  <div className="bg-[#FDFAF6] border border-[#EBE0D4] rounded-xl px-3 py-2.5">
                    <p className="text-[10px] font-semibold text-[#3D2B1F] mb-1">
                      Description
                    </p>
                ...
                <div className="flex flex-col gap-2">
                  <p className="text-[11px] font-bold text-[#2A1F1A]">
                    Delivery Options
                  </p>
                  ...
                  {(form.deliveryOption === 'Shipping' ||
                    ...
                    <div className="flex items-start gap-2 bg-[#F5EFE6] border border-[#E8DDD0] rounded-xl px-3 py-2.5">
                      <Truck
                        size={13}
                        className="text-[#A33214] mt-0.5 flex-shrink-0"
                      />
                      <div>
                        <p className="text-[11px] font-semibold text-[#2A1F1A]">
                          Shipping Available
                        </p>
                        <p className="text-[10px] text-[#6F6258] mt-0.5">
                          {form.shippingAvailability}
                          {form.shippingFeeType === 'Free Shipping' &&
                            ' · Free shipping'}
                          {form.shippingFeeType === 'Fixed Fee' &&
                            form.fixedShippingFee &&
                            ` · Rs ${form.fixedShippingFee}`}
                          {form.shippingFeeType === 'Dynamic Shipping' &&
                            form.rateWithinDistrict &&
                    ...
                    <div className="flex items-start gap-2 bg-[#F5EFE6] border border-[#E8DDD0] rounded-xl px-3 py-2.5">
                      ...
                      <div>
                        ...
                        {form.pickupDays.length > 0 &&
                          ...
                          form.pickupTimeTo && (
                            <p className="text-[10px] text-[#8A7060] mt-0.5">
                              {formatTime12h(form.pickupTimeFrom)} -{' '}
                              {formatTime12h(form.pickupTimeTo)} (
                  ...
                  {(form.deliveryOption === 'Pickup' ||
                    ...
                    <div className="flex items-start gap-1.5 text-[10px] text-[#8A7060] px-1">
                      ...
                      <span>
                        Exact location, contact number, and instructions will be
                ...
                {form.defectFlaws && (
                  <div className="flex items-start gap-1.5 bg-[#FFF8F6] border border-[#F0D8D0] rounded-xl px-3 py-2.5">
                    ...
                    />
                    <div>
                      <p className="text-[10px] font-semibold text-[#A33214] mb-0.5">
                        Noted Flaws
                      </p>
                      <p className="text-[11px] text-[#6F6258] leading-relaxed">
                        {form.defectFlaws}
                ...
                <div className="bg-[#FDF6EC] rounded-xl p-3">
                  <p className="text-[11px] font-bold text-[#2A1F1A] mb-2">
                    What buyers will see
                  </p>
                  {[
                    {
                      label: 'Clear photos and video',
                      met: form.photos.some(Boolean) || !!form.video,
                    },
                    {
                      label: 'Accurate details & measurements',
                      met: !!(form.size && form.material),
                    },
                    {
                      label: 'Honest condition & notes',
                      met: !!form.condition,
                    },
                    {
                      label: 'Fair pricing',
                      met: !!(form.thriftPrice || form.rentPerDay),
                    },
                    {
                    ...
                    >
                      ...
                      />
                      <span
                        className={`text-[10px] ${item.met ? 'text-[#6F6258]' : 'text-[#C8BAA8]'}`}
                      >
                        {item.label}
                      </span>
                    </div>
                ...
                <div>
                  ...
                  {[
                    {
                      icon: (
                        <CheckCircle size={12} className="text-[#A33214]" />
                      ),
                      title: 'Be honest about condition',
                      tip: 'Reduces returns and builds trust.',
                    },
                    {
                      icon: <Shirt size={12} className="text-[#A33214]" />,
                      title: 'Use measurements',
                      tip: 'Improves fit confidence.',
                    },
                    {
                      icon: <ImageIcon size={12} className="text-[#A33214]" />,
                      title: 'Good photos = more views',
                      tip: 'Natural photos sell faster.',
                    },
                    {
                      icon: (
                        <AlertCircle size={12} className="text-[#A33214]" />
                      ),
                      title: 'Answer messages quickly',
                      tip: 'Prompt replies = happy buyers.',
                    },
                  ].map((t) => (
