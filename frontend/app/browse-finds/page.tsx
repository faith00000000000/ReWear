                        ...
                        <div className="mx-auto max-w-[1380px]">
                            <div className="grid items-center gap-16 lg:grid-cols-[1fr_520px]">
                                ...
                                <div className="relative z-10 max-w-[620px]">
                                    ...
                                    {/* List an Item — visible only when authed (live, no refresh needed) */}
                                    {authed && (
                                ...
                                <div className="min-w-0">
                                    <div className="flex items-center justify-between border-b border-[#E4DDD3] px-6 py-5">
                                        <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-[#1A1A1A]">
                                            {loading ? "Loading…" : `${thriftProducts.length} Arrivals Found`}
                                        </p>
                                    ...
                                    {loading && (
                                        <div className="p-8 text-center text-[13px] text-[#707070]">Loading finds…</div>
                                    )}
                                    ...
                                    {!loading && !error && thriftProducts.length === 0 && (
                                        <div className="p-8 text-center text-[13px] text-[#707070]">
                                            No finds available right now.
                                        </div>
                                    )}
