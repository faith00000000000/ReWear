...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if ((request.getServletPath().startsWith("/api/notifications") || request.getServletPath().startsWith("/api/admin/") || request.getServletPath().startsWith("/api/rentals") || request.getServletPath().startsWith("/api/seller/earnings"))
